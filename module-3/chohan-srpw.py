...
while True:  # Main game loop.
    ...
    # Give 10 mon bonus if dice roll = 2 or 7
    bonus = dice1 + dice2
    if bonus == 7:
...
#    SHI - SAN
#      4 - 3
# You rolled a 7! You get a 10 mon bonus!
# You won! You take 2000 mon.
# The house collects a 166 mon fee.
# You have 6844 mon. How much do you bet? (or QUIT)
# SRPW: QUIT
# Thanks for playing!
#
